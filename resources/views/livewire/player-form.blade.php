<div>
    ...
    <form wire:submit.prevent="submit" enctype="multipart/form-data" class="account__block _block">
        <div class="account__hero1">
            <div class="account__body">
                <div class="account__field">
                    <div class="account__label">Прізвище</div>
                    <input type="text" placeholder="Прізвище" wire:model.defer="lastname" class="account__input input">
                    @error('lastname') <span class="error text-red-600">{{ $message }}</span> @enderror
                </div>
                <div class="account__field">
                    <div class="account__label">ІМ’Я</div>
                    <input type="text" placeholder="ІМ’Я" wire:model.defer="firstname" class="account__input input">
                ...
                <div class="account__field">
                    ...
                    <div class="account__date">
                        <input type="number" min="1" max="31" placeholder="01" wire:model.defer="day" class="account__input input">
                        <input type="number" min="1" max="12" placeholder="01" wire:model.defer="month" class="account__input input">
                        <input type="text" pattern="\d{4}" placeholder="1988" wire:model.defer="year" class="account__input input">
                    </div>
        ...
        <div class="account__rating-set">
            <div class="account__rating-block">
                ...
                <div class="account__rating rating">
                    {{-- Здесь либо встроенный рейтинг, либо твой отдельный компонент --}}
                    @livewire('rating', ['rating' => $rating])

                    {{-- ИЛИ простой выбор рейтинга, например: --}}
                    {{-- <input type="range" min="1" max="10" wire:model="rating"> --}}
                </div>
        ...
        <div class="account__data">
            <div class="account__field">
                <div class="account__label">НОМЕР ТЕЛЕФОНУ</div>
                <input type="text" placeholder="+380XXXXXXXXX" wire:model.defer="phone" class="account__input input">
                @error('phone') <span class="error text-red-600">{{ $message }}</span> @enderror
            </div>

            <div class="account__field">
                <div class="account__label">НІКНЕЙМ В TELEGRAM</div>
                <input type="text" placeholder="@MAMEDOV1988" wire:model.defer="tg" class="account__input input">
